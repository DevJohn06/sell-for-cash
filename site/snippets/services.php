    ...
    <?php $services_items = $data->services_items()->toStructure();
        ...
        <div>
            <div class="uk-grid-large" uk-grid>
                <div class="uk-width-1-2 uk-overflow-hidden">
                ...
                <div class="uk-width-1-2 section--background-services overlay filter-white" style="background-image: <?php if($img = $data->image($data->bkg_img())): ?> url('<?php echo thumb($img,array('width'=>2000, 'height'=>1500, 'crop'=>true))->url() ?>') <?php endif ?>">
